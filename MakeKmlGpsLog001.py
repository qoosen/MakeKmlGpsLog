...
def LogFileRead():
    ...
    Sector2StartPoint1 = [139.92050,36.15023]   #Sector2 start line point1 [Longitude,Latitude]/ セクター2開始線の点1 東経,北緯
    Sector2StartPoint2 = [139.92112,36.15028]   #Sector2 start line point2 [Longitude,Latitude]/ セクター2開始線の点2 東経,北緯
...
print ('Prosess has been done. / プロセスは終了しました。')